...
public class Main {
	...
	public static void main(String[] argv) {
		...
		if(argv.length != 12)
	    {
	        ...
	        "Enable service time logging [1 = true], Enable Message Generator [0 = off, 1,2,3,4,.. MessageGen Method], startClientID");
	        System.exit(0);
	    }
		String dbIP = argv[0];
		...
		Settings.SERVICE_TIME_LOGGING  = (1 == Integer.parseInt(argv[9]));
		boolean useMessageGenerator = (0!=Integer.parseInt(argv[10]));
		int messageGenMethod = Integer.parseInt(argv[10]);
		int firstClientID = Integer.parseInt(argv[11]);
