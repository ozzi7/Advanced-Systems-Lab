...
public class MessageGenerator implements Runnable {
	...
	private EventLogger responseLogger = null;
	...
	public void run() {
		...
		case 4:
			...
			break;
		case 5:
			sendQueryQueuesEmptyDB();
			break;
		case 6:
			sendPopQueueEmptyDB();
			break;
		case 7:
			sendMessageAnyReceiver200CharEmptyDB();
			break;
		case 8:
			sendPeekQueueEmptyDB();
			break;
		}
	}
	...
	public void sendPeekQueueEmptyDB()
	{
		try {
			int sentMessages = 0;
	...
	public void sendQueryQueuesEmptyDB()
	{
		try {
			int sentMessages = 0;
			...
			/*Reinsert a new request once a reply was received keeping the queues constant size */
			while (sentMessages < 10000) {
				Request request = new QueryQueues(1);
				lbq.put(request);
				sentMessages++;
				responseQueue.take();
			}
	...
	public void sendMessageAnyReceiver200CharEmptyDB()
	{
		try {
			int sentMessages = 0;
	...
	public void sendPopQueueEmptyDB()
	{
		try {
			int sentMessages = 0;
